...
public class Calculatrice {
	...
	private char stockOperator;
	private String stockOperand;
	...
	public void equal() {
		...
		if (this.operator == '0') {
			...
			this.operator = stockOperator;
			label_screen.setText(stockOperand);
		}
		calculation();
	}
	...
	public void calculation() {
		...
		if (this.operator == '+') {
			...
			stockOperator = operator;
			stockOperand = label_screen.getText();
	...
	public void mrc() {
		...
		label_screen.setText(roundResult.format(memory2));
	}

	public void mPlus() {
		
		memory2 = memory2 + Double.parseDouble(label_screen.getText());
	}
